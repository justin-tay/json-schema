...
import io.github.json.schema.path.JsonNodePath;
import io.github.json.schema.path.JsonPointer;
import io.github.json.schema.path.PathType;
import io.github.json.schema.path.UriReference;
...
public class SchemaLocation {
    private static final JsonNodePath JSON_POINTER = JsonPointer.atRoot();
    private static final JsonNodePath ANCHOR = UriReference.atRoot();
